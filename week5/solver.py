...
def read_distance_between_city(cities):
    N = len(cities)
...
def greedy(cities, start_city, dist):
    N = len(cities)
...
if __name__ == '__main__':
    ...
    dist = read_distance_between_city(cities)
